...
(function ($) {
    ...
    $.fn.autoGrowInput = function (o) {
        ...
        this.filter('input:text').each(function () {
            var minWidth = o.minWidth || $(this).width(), val = ' ', input = $(this), comfortZone = o.comfortZone ? o.comfortZone : parseInt(parseInt($(this).css('fontSize')) * 0.9), dummy = $('<dummy/>').css({
                position: 'absolute',
                top: -9999,
                left: -9999,
                width: 'auto',
                ...
                if (newWidth > o.maxWidth)newWidth = o.maxWidth;
                if (newWidth < o.minWidth)newWidth = o.minWidth;
