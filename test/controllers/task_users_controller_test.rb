...
class TaskUsersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create task_user" do
    assert_difference('TaskUser.count') do
      post task_users_url, params: { task_user: { task_id: @task_user.task_id, user_id: @task_user.user_id } }
    end
  ...
  test "should update task_user" do
    patch task_user_url(@task_user), params: { task_user: { task_id: @task_user.task_id, user_id: @task_user.user_id } }
